...
from my_agent.teacher_agent_tool import agent_low_temp,agent_high_temp
...
# !! modelsetting
input_prompt = "Write a poem about stars and also solve 5 + 3"

rich.print("\n🔵 LOW TEMP OUTPUT")
low_result = Runner.run_sync(agent_low_temp, input_prompt)
rich.print(low_result.final_output)

rich.print("\n🔴 HIGH TEMP OUTPUT")
high_result = Runner.run_sync(agent_high_temp, input_prompt)
rich.print(high_result.final_output)
